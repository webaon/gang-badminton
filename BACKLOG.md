...
- [x] ~~**`gangs_select_public` (0010) เปิดทั้ง "แถว" ไม่ใช่แค่ metadata**~~ — ✅ **WO-3.G / ADR-007**
      ...
      ⚠️ ทางเลือก (ค) **ย้าย `promptpay_id` ไปตาราง server-only** — **WO-5.D ตรวจแล้วว่าได้ผลน้อยกว่าที่คิด**:
      ...
      ถ้าจะทำจริงต้องแตะ snapshot ซึ่งแช่แข็งราคาไว้ (CLAUDE.md §2.4) ⇒ **ต้องมี ADR + ใบแยก**
